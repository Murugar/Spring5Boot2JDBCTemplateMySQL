			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label class="control-label" for="nome"> Name: </label> <input
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label class="control-label" for="endereco"> Address: </label> <input
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label class="control-label" for="telefone">Telephone: </label> <input
